...
public class GroupIronmanAssistantPlugin extends Plugin
{
	...
	@Inject
	private GroupIronmanAssistantConfig config;
	...
	@Provides
	GroupIronmanAssistantConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(GroupIronmanAssistantConfig.class);
	}
}
